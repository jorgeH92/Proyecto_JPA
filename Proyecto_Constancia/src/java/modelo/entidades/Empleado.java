...
public class Empleado implements Serializable {
    ...
    private Collection<ViajesRealizados> viajesRealizadosCollection;
    @OneToMany(mappedBy = "idRepartidorEmpleado")
    private Collection<ViajesRealizados> viajesRealizadosCollection1;
    @OneToMany(mappedBy = "dui")
    private Collection<Indemnizacion> indemnizacionCollection;
    ...
    @XmlTransient
    public Collection<ViajesRealizados> getViajesRealizadosCollection() {
        return viajesRealizadosCollection;
    }

    public void setViajesRealizadosCollection(Collection<ViajesRealizados> viajesRealizadosCollection) {
        this.viajesRealizadosCollection = viajesRealizadosCollection;
    }

    @XmlTransient
    public Collection<ViajesRealizados> getViajesRealizadosCollection1() {
        return viajesRealizadosCollection1;
    }

    public void setViajesRealizadosCollection1(Collection<ViajesRealizados> viajesRealizadosCollection1) {
        this.viajesRealizadosCollection1 = viajesRealizadosCollection1;
    }

    @XmlTransient
    public Collection<Indemnizacion> getIndemnizacionCollection() {
        return indemnizacionCollection;
    }

    public void setIndemnizacionCollection(Collection<Indemnizacion> indemnizacionCollection) {
        this.indemnizacionCollection = indemnizacionCollection;
    }
